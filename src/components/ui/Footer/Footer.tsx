    ...
    <footer className="w-full py-5 sm:py-10 px-4 bg-gray-200"> {/* Container */}
      ...
      <div className="flex flex-col-reverse sm:flex-row md:justify-between lg:justify-around">
        ...
        <div className="relative mt-14 sm:mt-0 px-5 flex flex-col justify-center items-center text-gray-500">
          {/* ::Site name */}
          <h1 className="font-title text-4xl text-center font-semibold mt-auto">Lens Vista</h1>
          {/* ::Social & copyright */}
          <div className="mt-auto flex flex-col items-center">
            ...
            {/* :::Copyright */}
            <span className="py-4 text-xs">&copy;{new Date().getFullYear()}, Lens Vista All Rights Reserved.</span>
          </div>
        ...
        <div className="grid grid-cols-2 gap-5 text-gray-400">
          ...
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4">
            ...
            <nav className="flex justify-around md:flex-col font-medium list-none">
              <li><a href="#link" className="hover:text-gray-900">Home</a></li>
              <li><a href="#link" className="hover:text-gray-900">Solutions</a></li>
              <li><a href="#link" className="hover:text-gray-900">Pricing</a></li>
              <li><a href="#link" className="hover:text-gray-900">About</a></li>
            </nav>
          </div>
          {/* ::Address */}
          ...
          {/* ::Email */}
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
            <h3 className="py-1.5 md:py-4 text-xl text-gray-500 font-bold tracking-wide">Lens Vista Company</h3>
            <p className="inline-flex justify-center sm:justify-start text-sm text-gray-400 font-medium">
              ...
              <a href="#email">lensvista@paradise.com</a>
            </p>
          </div>
          {/* ::Phone */}
          <div className="col-span-2 md:col-span-1 pb-0 md:py-3 px-4 flex flex-col items-center sm:items-start">
