    ...
    <div className="mx-auto py-10 px-4 w-full max-w-7xl bg-white text-gray-800">
      <div className="flex flex-col items-center space-y-12">
        ...
        <div className="mx-auto max-w-2xl space-y-3 text-center">
          ...
          {/* ::Text */}
          <p className="text-sm sm:text-base text-gray-700">We collaborate with industry leaders and established brands, fostering strong partnerships built on trust and mutual success.</p>
        </div>
